# ==============================================================
# File generated on Tue Jul 16 20:54:36 CST 2019
...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.cnna.autotvin_WEIGHTS_DDR.dat"
         "c.cnna.autotvin_FIN_DDR.dat"
         "c.cnna.autotvin_wddr_V.dat"
         "c.cnna.autotvin_fiddr_V.dat"
         "c.cnna.autotvin_foddr_V.dat"
         "c.cnna.autotvin_layer_wParaNext_memAddrBias_V.dat"
         "c.cnna.autotvin_layer_iPara_width.dat"
         "c.cnna.autotvin_layer_iPara_height.dat"
         "c.cnna.autotvin_layer_iPara_ciAlign_V.dat"
         "c.cnna.autotvin_layer_iPara_memAddrImgIn_V.dat"
         "c.cnna.autotvin_layer_oPara_co_V.dat"
         "c.cnna.autotvin_layer_oPara_memAddrImgOut_V.dat"
         "c.cnna.autotvin_layer_oParaNext_co_V.dat"
         "c.cnna.autotvout_FOUT_DDR.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.cnna.autotvout_FOUT_DDR.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
