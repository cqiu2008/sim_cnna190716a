    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > FIN_DDR_mem_depth) begin
                $display ("/home/cqiu/work/prj/AIPrj/hlsProject/CNNAHLSPrj/CNNAHLSProject/HLS102CNNA190716a/ipcodeCNNA190716a/solution1/sim/verilog/AESL_axi_master_FIN_DDR.v: Write request address %d exceed AXI master FIN_DDR array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, FIN_DDR_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > FIN_DDR_mem_depth) begin
                $display ("/home/cqiu/work/prj/AIPrj/hlsProject/CNNAHLSPrj/CNNAHLSProject/HLS102CNNA190716a/ipcodeCNNA190716a/solution1/sim/verilog/AESL_axi_master_FIN_DDR.v: Read request address %d exceed AXI master FIN_DDR array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, FIN_DDR_mem_depth); 
                $finish;
            end
